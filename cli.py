...
class ResumeParserCli(object):
    ...
    def extract_resume_data(self,url):
    ...
    def extract_from_remote_file(self,remote_file):
...
def add_user():
    ...
    parser.add_argument('-r', '--remotefile', help=url)
    cli_obj = ResumeParserCli()
    result = cli_obj.extract_from_remote_file(url)
